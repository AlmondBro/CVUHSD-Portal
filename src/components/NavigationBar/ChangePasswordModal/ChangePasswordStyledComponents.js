...
const ChangePasswordModalContainer = styled(Modal).attrs(props => ({
...
const ModalTextInputField = forwardRef(({ districtPosition, renderAsStudent, title, pathname, inputType, isOfTypePassword, placeholder, textArea, description, rows, cols, name, value, width, required, onChange }, ref) => {
...
export { 
    ...
    ChangePasswordModalContainer, SelectInputField, CloseButton, Form, ModalTitle, SelectDropDownArrow, Select, SubmitButton, FAIconStyled, TransferResultMessage, NoCVTechsMessage };